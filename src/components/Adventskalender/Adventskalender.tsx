...
const Adventskalender: React.FC<AdventskalenderProps> = ({ episodes }) => {
  ...
  if (date.getMonth() === 11) {
    for (var i = 0; i < episodes.length; i++) {
      if (i < today) {
        cards.push(<Card number={i + 1} url={episodes[i]} active="true" />);
      } else {
        cards.push(<Card number={i + 1} url="" active="false" />);
      }
    }
  } else {
  ...
  return (
    <>
      <div className={julestyle.container}>
        <div className={julestyle.gridContainer}>{cards}</div>
        <div className={julestyle.linkspace}>
          <ul className={julestyle.listStyle}>
            <li>
              <a href="https://www.youtube.com/playlist?list=PLSu-kJ8PGdcJg0K-rhNlab5V4dQCS21QY">
                click here to binge all episodes
              </a>
            </li>
            <li>
              <a href="https://www.youtube.com/watch?v=Dw63RZi5iPo">
                25 år med &quot;The Julekalender - Del 1&quot;
              </a>
            </li>
            <li>
              <a href="https://www.youtube.com/watch?v=lnv8t9JsqyQ">
                25 år med &quot;The Julekalender - Del 2&quot;
              </a>
            </li>
          </ul>
        </div>
