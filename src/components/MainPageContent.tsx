  ...
  return (
    <div className={styles.content}>
      <ContentCard title="Kommer 'snart'">
        ...
        <p>
          Det jobbes intenst med å få til noe nytt her! Du kan være med å bidra
          hvis du vil, alle forslag tas mot med stor takk! 😍
        </p>
        <h2>
          <a href="https://github.com/tplive/qvidahl-no">
